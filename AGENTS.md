# Agent Instructions for Bharatvaani

## Project Context
Bharatvaani is an open source Indic NLP specialization for 22 scheduled Indian languages.

## Repository Layout
- `src/aumai_bharatvaani/` — package source
